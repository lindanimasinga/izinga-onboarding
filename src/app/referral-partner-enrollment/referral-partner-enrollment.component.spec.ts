 ...
 * RP-ENR-06  API error: sets acceptError, clears saving flag.
...
describe('ReferralPartnerEnrollmentComponent', () => {
  ...
  beforeEach(async () => {
    ...
    mockOrderService = jasmine.createSpyObj('IzingaOrderManagementService', ['updateCustomer']);
  ...
  // RP-ENR-05
  it('RP-ENR-05: stores updated profile and navigates to dashboard on success', () => {
    const savedProfile = { ...baseProfile, icaAccepted: true } as UserProfile;
    mockOrderService.updateCustomer.and.returnValue(of(savedProfile));
    fixture.detectChanges();
  ...
  // RP-ENR-06
  it('RP-ENR-06: sets acceptError and clears saving flag on API failure', () => {
